...
export function buildWorkerSystemPrompt(): string {
  return [
    ...
    "",
    "The supervisor still records missing or invalid reports as warnings for audit, but the report itself is not the definition of success. Required files, write boundaries, and explicit acceptance checks are the important gates.",
    "",
...
export function buildWorkerPrompt(input: {
  ...
  return [
    ...
    "## Completion notes",
    "",
    "Complete the assigned work first. A structured report is useful but optional; missing reports are recorded as audit warnings rather than defining success by themselves.",
    "",
